...
> administration, qBittorrent global preference read/write for save paths,
> speed limits, queue caps, paused-add, temp path, and scheduler toggles,
...
> client replacement yet; Transmission global preferences, SABnzbd namespace
> administration, conflict handling, advanced queue arbitration, deeper native
> side effects for compatibility config, and broad download-client parity are
> still early.
...
- qBittorrent global preference read/write from the Downloads page and native
  `/api/v1/downloads/preferences` APIs for save paths, temp-path usage,
  paused-add behavior, queue caps, speed limits, and scheduler toggles.
