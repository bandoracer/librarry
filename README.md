...
> polling, details, queue-file inspection, and common job actions are
> implemented.
...
> client replacement yet; SABnzbd namespace administration, conflict handling,
> advanced queue arbitration, deeper native side effects for compatibility
> config, and broad download-client parity are still early.
