...
> administration, delete-with-data handling, and configurable active-queue
> rebalancing. It is a book-acquisition download manager, not a
...
> client replacement yet; global torrent-client preferences,
> SABnzbd namespace administration, conflict handling, advanced
> queue arbitration, deeper native side effects for compatibility config, and
> broad download-client parity are still early.
