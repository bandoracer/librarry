...
> jobs. Readarr-compatible manual import can list pending review items, scan a
> folder for candidates, and import selected files.
...
- Calibre Content Server add-book handoff for manual or completed-download
  ...
  and delete-books handoff when deleting Calibre-backed files physically.
...
- Calibre conversion polling, richer edition metadata sync, embedded metadata
  writes, path refresh after Calibre renames, and import rollback.
