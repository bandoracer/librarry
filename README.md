...
> full standalone torrent-client UI yet; bandwidth rules, non-qBittorrent
> torrent details, conflict handling, advanced queue arbitration, persistent
> compatibility config/resource editing, and broad download-client parity are
> still early.
...
- qBittorrent torrent details with properties, peer lists, tracker status,
  tracker add/edit/remove actions, file lists, and per-file
...
- qBittorrent integration for book categories, paused grabs, polling, simple
  ...
  import, recovery, priority actions, peer inspection, and tracker editing.
