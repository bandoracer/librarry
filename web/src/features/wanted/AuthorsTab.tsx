...
import { BookOpen, RefreshCw, Trash2, UserRoundSearch } from "lucide-react";
import {
  createWanted,
...
import { Badge, Button, Card, EmptyState, IconButton, InlineNotice, LoadingRow, Modal } from "../../components/ui";
import {
  appErrorMessage,
          ...
          {subscriptionsQuery.isLoading ? (
            ...
            <div className="wanted-author-list">
              {subscriptions.map((subscription) => {
                ...
                return (
                  <article className="wanted-author-row" key={monitorKey}>
